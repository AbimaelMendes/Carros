					...
					if($veiculos){
						foreach($veiculos as $veiculo){
							echo '<tr>';
								...
								echo '<td> <a href="delete.php?id='.$veiculo['id'].'"><button type="button" class="btn btn-danger">Deletar</button></a>'.'  '.'<a href="edit.php?id='.$veiculo['id'].'"><button type="button" class="btn btn-info">Editar</button></a></td>';		
							echo '</tr>';	
						}
					}
				?>
