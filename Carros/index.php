...
<body>
	<div class="pos-f-t">
	  <nav class="navbar navbar-dark bg-dark">
	    ...
	    <div>
	      	<h6 class="text-white">Seja bem vindo <?php session_start(); echo $_SESSION['email'];?>
			</h6>
		...
		<div class="row align-items-md-stretch">
	      ...
	      <div class="col-md-6">
	        <div class="h-100 p-5 bg-light border rounded-3">
	          <h2>Visulaizar veículos</h2>
	          <p>Visualize, edite e exclua veíclos.</p>
